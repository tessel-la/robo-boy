...
describe('parseGeneratedBehaviorTree', () => {
      ...
      JSON.stringify({
        ...
        nodes: [
          ...
          },
          {
            ...
            type: 'service',
            label: 'Capture',
            config: { serviceName: '/capture', serviceType: 'camera/srv/Capture' },
          },
        ],
        edges: [
  ...
  it('parses an explanation without treating it as a tree', () => {
    expect(
      parseGeneratedAgentResponse(
        JSON.stringify({
          kind: 'explanation',
          message: 'The selector tries each child until one succeeds.',
        })
      )
    ).toEqual({
      kind: 'explanation',
      ...
      JSON.stringify({
        ...
        nodes: [
          ...
          { id: 'branch', type: 'ifElse', config: { variable: 'obstacle', operator: 'truthy' } },
          {
            id: 'stop',
            type: 'topic',
            config: { topicName: '/cmd', messageType: 'std_msgs/msg/String', message: { data: 'stop' } },
          },
      ...
      JSON.stringify({
        ...
        nodes: [
          ...
          { id: 'branch', type: 'ifElse', variable: 'ready', operator: 'exists', expectedValue: true },
          {
            ...
            type: 'service',
            serviceName: '/capture',
            serviceType: 'camera/srv/Capture',
            request: { quality: 80 },
          },
          {
            id: 'topic',
            ...
            config: {
              ...
              message: { data: 'go' },
              inputBindings: [{ variable: 'speed', targetPath: 'linear.x' }],
            },
          },
        ],
        edges: [],
